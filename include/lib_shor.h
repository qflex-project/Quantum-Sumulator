...
vector<int> Shor(long N, int type, int n_threads, int cpu_region,
...
vector<string> CU(int qubits, int ctrl, int reg1, int reg2, int width, long a,
                  long N);

vector<string> CMultMod(int qubits, int ctrl, int reg1, int reg2, int over,
                        int over_bool, int width, long a, long N);
vector<string> CRMultMod(int qubits, int ctrl, int reg1, int reg2, int over,
                         int over_bool, int width, long a, long N);
vector<string> C2AddMod(int qubits, int ctrl1, int ctrl2, int reg, int over,
                        int over_bool, int width, long a, long N);
vector<string> C2SubMod(int qubits, int ctrl1, int ctrl2, int reg, int over,
                        int over_bool, int width, long a, long N);

string C2AddF(int qubits, int ctrl1, int ctrl2, int reg, int over, long num,
              int width);
...
vector<string> AddF(int qubits, int reg, int over, long num, int width,
                    bool controlled);

string C2SubF(int qubits, int ctrl1, int ctrl2, int reg, int over, long num,
              int width);
...
vector<string> SubF(int qubits, int reg, int over, long num, int width,
                    bool controlled);
